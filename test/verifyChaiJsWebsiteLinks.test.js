...
describe.only("Verify whether chaijs.com links on home page works correctly", () => {
  ...
  it("User should be able to navigate to Guide Page of chaijs.com", () => {
    browser.url("https://www.chaijs.com");
  ...
  it("User should be able to navigate to API Page of chaijs.com", () => {
    ...
    title.should.be
      .a("string")
      .and.equal("Introduction - Chai", "title is not 'Introduction - Chai'");
  });
});
